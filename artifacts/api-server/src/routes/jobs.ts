...
router.get("/jobs/government", (_req, res) => {
  const governmentJobs = [
    ...
    },
    {
      ...
      type: "Full-time",
      description: "DRDO 2025 recruitment for Scientist posts in Computer Science, Electronics, and Mechanical Engineering disciplines.",
    ...
    },
    {
      ...
      type: "Full-time",
      description: "SSC CPO Sub-Inspector and Constable GD recruitment 2025 for Central Armed Police Forces.",
    ...
    },
    {
      ...
      type: "Full-time",
      description: "FCI Recruitment 2025 for Junior Engineer, Assistant Grade and Technical Officer posts across zones.",
    ...
    },
    {
      ...
      type: "Full-time",
      description: "RBI Grade B Officer (DR) recruitment 2025 for Systems stream. Work on critical banking technology infrastructure.",
