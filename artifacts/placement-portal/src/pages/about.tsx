    ...
    <div className="container mx-auto px-4 py-16 max-w-5xl">
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-muted-foreground">
          A BCA final-year project designed to revolutionize the campus
          placement ecosystem.
        </p>
      </div>
        ...
        <section>
          ...
          <Card className="glass-card">
            <CardContent className="pt-6 text-lg text-muted-foreground leading-relaxed">
              ...
              often manual, fragmented, and inefficient. Students struggle to
              find relevant opportunities that match their specific skill sets,
              while employers spend excessive time screening mismatched resumes.
              The lack of a centralized, intelligent platform leads to missed
              opportunities and suboptimal placement rates.
            </CardContent>
          </Card>
        </section>
        ...
        <section>
          ...
          <Card className="glass-card border-primary/20">
            <CardContent className="pt-6 text-lg text-muted-foreground leading-relaxed">
              ...
              optimizes the placement workflow. By leveraging intelligent
              matching algorithms, we connect students with the right employers
              based on skills, academic performance, and career interests. The
              platform serves as a single source of truth for placement cells,
        ...
        <section>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              { name: "Dedraj", role: "UI/UX & Frontend", uid: "23BCA10029" },
              {
                name: "Bashu Kumar",
              ...
              <Card
                key={i}
                className="text-center glass-card hover:-translate-y-1 transition-transform duration-300"
              >
                <CardHeader>
